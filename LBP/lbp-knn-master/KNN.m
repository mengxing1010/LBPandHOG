function [neighborIds,neighborClass,neighborDistances] = KNN(dataMatrix,classes, queryMatrix, k)
%--------------------------------------------------------------------------
